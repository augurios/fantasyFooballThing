      ...
      <div>
            ...
            <div className="container-fluid mb-4">
              ...
              <div className="col">
                <div className={"row team-stats " + (this.props.games ? 'visible' : 'hidden')}>
                  ...
                  <div className="nums">
                    ...
                    <p><strong>Average Points:</strong> {this.props.teama.totalPoints / (this.props.teamb.record + this.props.teama.record)}</p>
              ...
              <p> {this.props.teamb.highestlosestreak}</p>
                    ...
                    <p> {this.props.teamb.totalPoints / (this.props.teamb.record + this.props.teama.record) }</p>
